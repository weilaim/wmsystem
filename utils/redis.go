...
// 通用执行指令方法
// func(*_redisUtil)Execute(cmd string, args ...any)(any, error){
...
// redis 将 key 中存储的数字 + 1
// 如果 key 不存在， 默认的初始化为0 再执行INCR操作
// 如果值 包含错误的类型，或是字符串类型的值表示为数字，返回错误
